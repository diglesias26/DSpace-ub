/**
 *  EmbargoServiceImpl.java (era EmbargoManager.java a 5.7)
 *  diglesias: 
 *   - 29/08/2018 revisat per a 5.8 
 *   - 09/09/2015 revisat per a 5.3 
 *   - 23/05/2012 revisat per a 1.8.2 
 *   - abril 2012 adaptat segons mail ilabastida 1/4/2012
...
public class EmbargoServiceImpl implements EmbargoService {
    ...
    public void liftEmbargo(Context context, Item item)
        ...
        // NOU: ilabastida 7/3/2012
        // ilabastida 20/02/2012 set the dc.rights.accessRights to right open
		itemService.clearMetadata(context, item, MetadataSchemaEnum.DC.getName(), "date", "embargoEndDate", Item.ANY);
        itemService.clearMetadata(context, item, MetadataSchemaEnum.DC.getName(), "rights", "accessRights" , Item.ANY);
        itemService.addMetadata(context, item, MetadataSchemaEnum.DC.getName(), "rights", "accessRights", null, "info:eu-repo/semantics/openAccess");
		// FI NOU
